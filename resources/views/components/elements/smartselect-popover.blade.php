...
@elseif ($theme == 'bootstrap-4')
    <div x-show="popOpen" x-transition @click.outside="popOpen = false" :class="{ 'pb-2': popOpen }"
        class="position-absolute origin-top-right md:left-64 right-0 md:top-0 md:w-56 rounded-md shadow-lg bg-white dark:bg-gray-700 text-black dark:text-white ring-1 ring-black ring-opacity-5 focus:outline-none"
        ...
        <div class="pt-1 z-50">
            ...
            <div class="w-100 d-flex flex-column" class="w-40em">
                <template x-for="(item,index) in newSelectedItems">
                    <div class="d-inline-block w-100 text-left pl-2 py-1 text-black dark:text-white text-sm hover:bg-blue-500 dark:hover:bg-gray-400"
                        :class="{ 'dark:bg-gray-800': (index % 2) }">
