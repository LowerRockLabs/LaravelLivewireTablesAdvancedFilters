...
class AdvancedFilterHelpersTest extends TestCaseAdvanced
{
    ...
    /** @test */
    public function can_get_component_filter_by_key_two(): void
    {
        $this->assertNotInstanceOf(MultiSelectFilter::class, $this->advancedTable->getFilterByKey('test'));
    ...
    public function can_set_filter_value(): void
    {
        ...
        /** @test */
        public function can_set_filter_value_3(): void
        {
            $this->advancedTable->setFilter('breed', ['1']);
    ...
    public function can_get_all_applied_filters_with_values(): void
    {
        ...
        $this->assertSame(['breed' => [0 => '1'], 'species' => [0 => '0']], $this->advancedTable->getAppliedFiltersWithValues());

        $this->advancedTable->setFilter('datepicker', '2020-10-10');

        $this->assertSame(['breed' => [0 => '1'], 'species' => [0 => '0'], 'datepicker' => '2020-10-10'], $this->advancedTable->getAppliedFiltersWithValues());
    }
